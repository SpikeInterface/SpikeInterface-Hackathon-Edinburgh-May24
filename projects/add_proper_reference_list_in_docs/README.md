# Project title: Add proper reference list in docs

### Key Investigators

* Anyone happy to contribute

## Project Description

Add a documentation page on how to cite and add references for each function/tool
